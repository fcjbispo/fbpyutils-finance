...
setup(
    ...
    name="fbpyutils-finance",  # Required
    ...
    #
    dependency_links=[
        "https://github.com/fcjbispo/builds/raw/main/fbpyutils/fbpyutils-1.4.1-py3-none-any.whl"
    ],
    # If using Python 2.6 or earlier, then these have to be included in
    # MANIFEST.in as well.
    # package_dir={"fbpyutils_finance": "fbpyutils_finance"},
    package_data={
        "fbpyutils_finance": [path.sep.join(["cvm", "data", "*.xlsx"])]
    },  # Optional
    ...
    project_urls={  # Optional
        ...
        "Funding": "",
        "Say Thanks!": "",
        "Source": "https://github.com/fcjbispo/fbpyutils-finance",
    },
)
